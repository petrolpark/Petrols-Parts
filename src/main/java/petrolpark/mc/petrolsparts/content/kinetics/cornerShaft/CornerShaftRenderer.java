...
public class CornerShaftRenderer extends EncasedCornerShaftRenderer {
    ...
    public static CornerShaftRenderer vanilla(BlockEntityRendererProvider.Context context) {
        return new CornerShaftRenderer(PetrolsPartsPartialModels.CORNER_SHAFT_CENTER, PetrolsPartsPartialModels.CORNER_SHAFT_SIDE, PetrolsPartsPartialModels.CORNER_SHAFT_SIDE_GRIP, PetrolsPartsPartialModels.CORNER_SHAFT_GIMBAL, context);
    };

    protected final PartialModel center, sideGrip, gimbal;

    public CornerShaftRenderer(PartialModel center, PartialModel side, PartialModel sideGrip, PartialModel gimbal, BlockEntityRendererProvider.Context context) {
        super(side, context);
        this.center = center;
        this.sideGrip = sideGrip;
        this.gimbal = gimbal;
    };
    ...
    protected void renderMiddle(CornerShaftBlockEntity cornerShaftBlockEntity, BlockState state, PoseStack ms, VertexConsumer vbSolid, int light, Direction shaft1Direction, Direction shaft2Direction, float gimbal1Angle, float gimbal2Angle) {
        ...
        SuperByteBuffer grip1 = CachedBuffers.partialFacing(sideGrip, state, shaft1Direction);
        ...
        SuperByteBuffer grip2 = CachedBuffers.partialFacing(sideGrip, state, shaft2Direction);
        ...
        CachedBuffers.partial(center, state)
        ...
        CachedBuffers.partialFacing(gimbal, state, shaft1Direction)
        ...
        CachedBuffers.partialFacing(gimbal, state, shaft2Direction)
